function [y] = fresnelC(x,n)
%fresnelC This function finds a Simpson's rule approximation for the area under the graph f(t)=cos(t^2) with varying interval of integration length x and lower limit zero 
f=@(t) cos(t.^2);%calls the function cos(t.^2) indirectly with dummy variable t
